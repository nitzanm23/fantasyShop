    ...
    <section class="my-footer-background-color">
          ...
          <div id="footer-download">
            ...
            <a class="ripple m-1 my-social-img-width" href="#!" role="button">
              <img
                src="./assets/images/nav_and_footer/android-icon.svg"
            ...
            <a class="ripple m-1 my-social-img-width" href="#!" role="button">
              <img
                src="./assets/images/nav_and_footer/ios-icon.svg"
                class="img-fluid rounded my-img-drop-black-shadow"
        ...
        <section>
          <ul id="footer-menu" class="grid container">
            ...
            <li>
              <img
                src="./assets/images/nav_and_footer/logo.svg"
                class="my-img-drop-black-shadow"
                alt="Fantasy Shop"
                draggable="false"
              />
              <p>
                FantasyShop is an online retail store (E-Commerce) renowned for its wide
